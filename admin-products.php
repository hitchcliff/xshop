...
$data = db_select("products", "WHERE 1 ORDER BY id DESC");
?>
            ...
            <section class="pt-lg-4 pb-4 mb-3">
                <div class="pt-2 px-4 ps-lg-0 pe-xl-5">
                    ...
                    <div class="d-sm-flex flex-wrap justify-content-between align-items-center border-bottom">
                        <h2 class="h3 py-2 me-2 text-center text-sm-start">All products<span
                                class="badge bg-faded-accent fs-sm text-body align-middle ms-2"><?= count($data) ?></span>
                        </h2>
                    </div>
                    <?php

                    foreach ($data as $key => $d) {
                        $img = json_decode($d['photo'])[0]->thumb; // first image
                        ...
                        <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a
                            ...
                            <div class="text-center text-sm-start">
                                ...
                                <div class="d-inline-block text-accent"><?= $price ?></div>
                                    ...
                                    <div class="d-flex justify-content-center justify-content-sm-start pt-3">
                                        <button class="btn bg-faded-accent btn-icon me-2" type="button"
                                            data-bs-toggle="tooltip" title="Download"><i
                                                class="ci-download text-accent"></i></button>
                                        <button class="btn bg-faded-info btn-icon me-2" type="button"
                                            data-bs-toggle="tooltip" title="Edit"><i class="ci-edit text-info"></i></button>
