    ...
    <div class="pt-2 px-4 ps-lg-0 pe-xl-5">
        ...
        <form method="post" action="admin-categories-create.php">
            <div class="mb-3 pb-2">
                ...
                <input class="form-control" type="text" id="unp-product-name" name="category_name">
            ...
            <button class="btn btn-primary d-block w-100" type="submit"><i class="ci-cloud-upload fs-lg me-2"></i>Upload
                Product</button>
        </form>
    </div>
</section>